...
var INITIAL_COMPETENCIES, INITIAL_USERS, INITIAL_LEARNER_COMPETENCIES, INITIAL_GAP_ANALYSIS, INITIAL_LEARNING_PATH, INITIAL_ASSESSMENTS, INITIAL_WORKFORCE_METRICS, InMemoryDatabase, db, MOCK_IGOT_COURSES, IGOTClient, igotAdapter, MOCK_NSSTA_PROGRAMMES, NSSTAClient, nsstaAdapter, MOCK_TPAC_MANDATES, TPACClient, tpacAdapter, UNIFIED_CATALOGUE_DATASET, UnifiedCatalogueService, genAIClient, lastQuotaExhaustedTime, QUOTA_COOLDOWN_MS, diagnosisCache, questionsCache, DOMAIN_DIAGNOSTICS, generateAIGapDiagnosis, express, Pool, dbHealthPool, app, app_default;
var init_app = __esm({
  "server/app.js"() {
