...
var INITIAL_COMPETENCIES, INITIAL_USERS, INITIAL_LEARNER_COMPETENCIES, INITIAL_GAP_ANALYSIS, INITIAL_LEARNING_PATH, INITIAL_ASSESSMENTS, INITIAL_WORKFORCE_METRICS, InMemoryDatabase, db;
var init_db = __esm({
  "server/db.ts"() {
...
// server/integrations/igot/igot.mock.ts
var MOCK_IGOT_COURSES;
var init_igot_mock = __esm({
  "server/integrations/igot/igot.mock.ts"() {
    MOCK_IGOT_COURSES = [
      {
        id: "igot-py-101",
...
// server/integrations/igot/igot.client.ts
var IGOTClient, igotAdapter;
var init_igot_client = __esm({
  "server/integrations/igot/igot.client.ts"() {
    init_igot_mock();
    IGOTClient = class {
      constructor() {
    ...
    igotAdapter = new IGOTClient();
  }
});

// server/integrations/nssta/nssta.mock.ts
var MOCK_NSSTA_PROGRAMMES;
var init_nssta_mock = __esm({
  "server/integrations/nssta/nssta.mock.ts"() {
...
// server/integrations/nssta/nssta.client.ts
var NSSTAClient, nsstaAdapter;
var init_nssta_client = __esm({
  "server/integrations/nssta/nssta.client.ts"() {
    init_nssta_mock();
    NSSTAClient = class {
      constructor() {
    ...
    nsstaAdapter = new NSSTAClient();
  }
});

// server/integrations/tpac/tpac.mock.ts
var MOCK_TPAC_MANDATES;
var init_tpac_mock = __esm({
  "server/integrations/tpac/tpac.mock.ts"() {
    init_nssta_mock();
    MOCK_TPAC_MANDATES = [
      {
...
// server/integrations/tpac/tpac.client.ts
var TPACClient, tpacAdapter;
var init_tpac_client = __esm({
  "server/integrations/tpac/tpac.client.ts"() {
    init_tpac_mock();
    init_nssta_mock();
    TPACClient = class {
    ...
    tpacAdapter = new TPACClient();
  }
});

// server/integrations/catalogue.service.ts
var UNIFIED_CATALOGUE_DATASET, UnifiedCatalogueService;
var init_catalogue_service = __esm({
  "server/integrations/catalogue.service.ts"() {
    UNIFIED_CATALOGUE_DATASET = [
      // ==========================================
...
var genAIClient, lastQuotaExhaustedTime, QUOTA_COOLDOWN_MS, diagnosisCache, questionsCache, DOMAIN_DIAGNOSTICS, generateAIGapDiagnosis;
var init_gemini = __esm({
  "server/ai/gemini.ts"() {
    genAIClient = null;
    lastQuotaExhaustedTime = 0;
    QUOTA_COOLDOWN_MS = 6e4;
    diagnosisCache = /* @__PURE__ */ new Map();
    questionsCache = /* @__PURE__ */ new Map();
    DOMAIN_DIAGNOSTICS = {
      python: {
    ...
    generateAIGapDiagnosis = generateAIGapExplanation;
  }
});

// server/utils/learnerProfileCompetency.ts
...
var init_learnerProfileCompetency = __esm({
  "server/utils/learnerProfileCompetency.ts"() {
    init_db();
    init_gemini();
  }
...
var express, Pool, dbHealthPool, app, app_default;
var init_app = __esm({
  "server/app.ts"() {
    init_db();
    init_igot_client();
    init_nssta_client();
    init_tpac_client();
    init_catalogue_service();
    init_gemini();
    init_learnerProfileCompetency();
    init_db_url();
    express = expressPkg.default || expressPkg;
    Pool = pg.Pool || pg.default?.Pool || pg;
    dbHealthPool = null;
...
async function handler(req, res) {
  ...
  try {
    const app2 = await getAppInstance();
